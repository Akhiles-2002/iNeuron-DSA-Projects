...
public class Q6TowerOfHanoi {
    ...
    public static void main(String[] args) {
        int N = 2;
        System.out.println("Steps to solve Tower of Hanoi for N = " + N + ":");
        solveTowerOfHanoi(N, '1', '2', '3');
        System.out.println("Total moves required: " + getTotalMoves(N));
    }
}
